...
export const translations = {
  en: {
    ...
    // Home page specific
    journeyWithFriend: 'Journey With Your Blue Friend',
    trackDailyGoals: 'Track daily goals',
    howDoYouFeel: 'How do you feel?',
    understandingAnxiety: 'Understanding anxiety',
    ...
    beKindToYourself: 'Remember to be kind to yourself today. Every small step counts.',

    // Journal specific
    noEntriesYet: 'No entries yet',
    startTrackingEpisodes: 'Start tracking your episodes to identify patterns',
    ...
    affirmationsCount: 'affirmations',
    dailyPracticeTips: 'Daily Practice Tips',
    readAffirmationsAloud: 'Read affirmations aloud with conviction and belief',
    practiceFor5to10Minutes: 'Practice for 5-10 minutes each morning',
    chooseResonatingAffirmations: 'Choose affirmations that resonate with your current needs',
    bePatientWithChanges: 'Be patient - positive changes take time to manifest',
    ...
    calmingRoutine: 'Calming routine to prepare for sleep',
    forestDreams: 'Forest Dreams',
    peacefulJourneyWoods: 'A peaceful journey through moonlit woods',
    oceanWaves: 'Ocean Waves',
    driftAwayOcean: 'Drift away with gentle ocean sounds',
    bodyScanSleep: 'Body Scan for Sleep',
    releaseTensionHeadToe: 'Release tension from head to toe',
    sleepBreathing478: '4-7-8 Sleep Breathing',
    breathingFasterSleep: 'Breathing technique for faster sleep onset',
    gratitudeBeforeSleep: 'Gratitude Before Sleep',
    endDayThankfulness: 'End your day with thankfulness',
    betterSleepTips: 'Better Sleep Tips',
    keepConsistentSchedule: 'Keep a consistent sleep schedule',
    avoidScreensBeforeBed: 'Avoid screens 1 hour before bed',
    keepRoomCoolDark: 'Keep your room cool and dark',
    limitCaffeineAfter2PM: 'Limit caffeine after 2 PM',
    findComfortablePosition: 'Find a comfortable position and let yourself relax completely',

    // Checklist specific
    breathe: 'Breathe',
    startTodaysExercises: 'Start Today\'s Exercises',
    addJournalEntry: 'Add Journal Entry',

    // Mood Tracker specific
    moodRecorded: 'Mood Recorded!',
    thankYouSharing: 'Thank you for sharing how you feel today',
    ...
    tip: 'Tip',
    moodTrackingHelps: 'Regular mood tracking helps identify patterns and triggers. Keep logging daily for better insights!',
    viewAllEntries: 'View All Entries',

    // Exercises specific
    emergencyCalm: 'Emergency Calm',
    quickTechniqueCalm: 'Quick technique for instant calm in crisis',
    triangularBreathing: 'Triangular Breathing',
    inhaleHoldExhale: 'Inhale, hold, exhale in balanced rhythm',
    bellyBreathing: 'Belly Breathing',
    deepAbdominalBreathing: 'Deep abdominal breathing for complete relaxation',
    mindfulWalking: 'Mindful Walking',
    walkWithAwareness: 'Walk with full awareness and presence',
    fiveSensesExercise: 'Five Senses Exercise',
    connectSurroundings: 'Connect with surroundings through your five senses',
    presentMomentMeditation: 'Present Moment Meditation',
    focusNowLetGo: 'Focus on now, let go of past and future',
    yourPeacefulPlace: 'Your Peaceful Place',
    visualizeTravelPeaceful: 'Visualize and travel to your favorite peaceful place',
    colorHealingMeditation: 'Color Healing Meditation',
    useHealingPowerColors: 'Use the healing power of colors for emotional wellness',
    fullBodyTensionRelease: 'Full Body Tension Release',
    tenseRelaxMuscle: 'Tense and relax every muscle to release tension',
    lovingKindnessMeditation: 'Loving Kindness Meditation',
    cultivateLoveCompassion: 'Cultivate love and compassion in your heart',
    soothingNatureSounds: 'Soothing nature sounds for deep relaxation',
    gentleOceanWaves: 'Gentle ocean waves for complete tranquility',
    relaxingRainDrops: 'Relaxing rain drops to calm the mind',
    exerciseLibraryStats: 'Exercise Library Stats',
  ...
  ar: {
    ...
    // Home page specific
    journeyWithFriend: 'رحلة مع صديقك الأزرق',
    trackDailyGoals: 'تتبع الأهداف اليومية',
    howDoYouFeel: 'كيف تشعر؟',
    understandingAnxiety: 'فهم القلق',
    positiveAffirmations: 'تأكيدات إيجابية',
    trackYourJourney: 'تتبع رحلتك',
    sleepBetter: 'نوم أفضل',
    preferences: 'التفضيلات',
    youreDoingGreat: 'أنت تقوم بعمل رائع!',
    beKindToYourself: 'تذكر أن تكون لطيفاً مع نفسك اليوم. كل خطوة صغيرة لها قيمة.',

    // Journal specific
    noEntriesYet: 'لا توجد مذكرات بعد',
    startTrackingEpisodes: 'ابدأ بتتبع نوباتك لتحديد الأنماط',
    ...
    pause: 'توقف',
    play: 'تشغيل',
    newAffirmation: 'تأكيد جديد',
    affirmationsCount: 'تأكيدات',
    dailyPracticeTips: 'نصائح الممارسة اليومية',
    readAffirmationsAloud: 'اقرأ التأكيدات بصوت عالٍ مع الاقتناع والإيمان',
    practiceFor5to10Minutes: 'مارس لمدة 5-10 دقائق كل صباح',
    chooseResonatingAffirmations: 'اختر التأكيدات التي تتناسب مع احتياجاتك الحالية',
    bePatientWithChanges: 'كن صبوراً - التغييرات الإيجابية تحتاج وقت لتظهر',
    ...
    breathing: 'التنفس',
    meditation: 'التأمل',
    calmingRoutine: 'روتين مهدئ للتحضير للنوم',
    forestDreams: 'أحلام الغابة',
    peacefulJourneyWoods: 'رحلة هادئة عبر الغابات المضاءة بنور القمر',
    oceanWaves: 'أمواج المحيط',
    driftAwayOcean: 'انجرف بعيداً مع أصوات المحيط الهادئة',
    bodyScanSleep: 'مسح الجسم للنوم',
    releaseTensionHeadToe: 'اطلق التوتر من الرأس إلى أصابع القدمين',
    sleepBreathing478: 'تنفس النوم 4-7-8',
    breathingFasterSleep: 'تقنية التنفس لنوم أسرع',
    gratitudeBeforeSleep: 'الامتنان قبل النوم',
    endDayThankfulness: 'اختتم يومك بالشكر',
    betterSleepTips: 'نصائح لنوم أفضل',
    keepConsistentSchedule: 'حافظ على جدول نوم ثابت',
    avoidScreensBeforeBed: 'تجنب الشاشات ساعة واحدة قبل النوم',
    keepRoomCoolDark: 'اجعل غرفتك باردة ومظلمة',
    limitCaffeineAfter2PM: 'قلل الكافيين بعد الساعة 2 ظهراً',
    findComfortablePosition: 'اجد وضعية مريحة واتركه نفسك تسترخي تماماً',

    // Checklist specific
    breathe: 'تنفس',
    startTodaysExercises: 'ابدأ تمارين اليوم',
    addJournalEntry: 'إضافة مذكرة',

    // Mood Tracker specific
    moodRecorded: 'تم تسجيل المزاج!',
    thankYouSharing: 'شكراً لك لمشاركة شعورك اليوم',
    recordMood: 'سجل المزاج',
    recentMoodEntries: 'مذكرات المزاج الأخيرة',
    moodInsights: 'رؤى المزاج',
    totalEntries: 'إجمالي المذكرات',
    dayStreak: 'سلسلة الأيام',
    tip: 'نصيحة',
    moodTrackingHelps: 'تتبع المزاج بانتظام يساعد على تحديد الأنماط والمحفزات. استمر في التسجيل يومياً للحصول على رؤى أفضل!',
    viewAllEntries: 'عرض جميع المذكرات',

    // Exercises specific
    emergencyCalm: 'هدوء الطوارئ',
    quickTechniqueCalm: 'تقنية سريعة للهدوء الفوري في الأزمات',
    triangularBreathing: 'التنفس المثلثي',
    inhaleHoldExhale: 'استنشق، احبس، ازفر بإيقاع متوازن',
    bellyBreathing: 'التنفس البطني',
    deepAbdominalBreathing: 'تنفس عميق من البطن للاسترخاء التام',
    mindfulWalking: 'المشي الواعي',
    walkWithAwareness: 'امشي بوعي واحضور كامل للحظة',
    fiveSensesExercise: 'تمرين الحواس الخمس',
    connectSurroundings: 'اربط مع محيطك من خلال حواسك الخمس',
    presentMomentMeditation: 'تأمل اللحظة الحاضرة',
    focusNowLetGo: 'ركز على الآن واترك الماضي والمستقبل',
    yourPeacefulPlace: 'مكانك السلمي',
    visualizeTravelPeaceful: 'تخيل وانتقل لمكانك المفضل الهادئ',
    colorHealingMeditation: 'الشفاء بالألوان',
    useHealingPowerColors: 'استخدم قوة الألوان للشفاء النفسي',
    fullBodyTensionRelease: 'إطلاق التوتر',
    tenseRelaxMuscle: 'شد واسترخ كل عضلة لإطلاق التوتر',
    lovingKindnessMeditation: 'تأمل الرحمة والمحبة',
    cultivateLoveCompassion: 'زرع المحبة والرحمة في قلبك',
    soothingNatureSounds: 'أصوات الطبيعة المهدئة للاسترخاء العميق',
    gentleOceanWaves: 'أمواج المحيط الهادئة للسكينة التامة',
    relaxingRainDrops: 'قطرات المطر المريحة لتهدئة العقل',
    exerciseLibraryStats: 'إحصائيات التمارين',
    exercisesPlural: 'تمرين',
    categories: 'فئة',
    benefits: 'فوائد',
    noExercisesCategory: 'لا توجد تمارين في هذه الفئة',
    quick: 'سريع',
    natureSounds: 'أصوات طبيعية',
